...
<body>
    <div class="container">
        <div class="header">
            <h2>Reset your Prudence ShowRoom Password!</h2>
        </div>
        <div class="content">
            ...
            <p>If you did not create a request to reset your password, please ignore this email or contact our support team at <b>info@prudenceshowroom.com</b>.</p>
